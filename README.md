...
Её можно вырезать при помощи клавиши PrtSc или инструмента "Ножницы" и вставить в Paint, а дальше заняться следующим: по мере открытия выделяем целый столбец или строку, меняем их местами с другими столбцами/строками, так получается красиво и наглядно.
