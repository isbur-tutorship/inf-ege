...
### Эквиваленты записи логических операций в математике и в Python
...
### Пример с дополнительным условием (исключение пункта)
